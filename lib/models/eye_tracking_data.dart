class TetrisEyeTrackingData {
  ...
  static TetrisEyeTrackingData fromJson(Map<dynamic, dynamic>? json) => TetrisEyeTrackingData(
        eye_tracking_data_csv_file: json!['eye_tracking_data_csv_file'] as String,
