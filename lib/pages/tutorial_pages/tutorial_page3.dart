  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton:
          const TutorialPagesNextButton(routeName: RouteManager.tutorialPage4),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text.rich(
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: translation(context).arrowKeys,
                      style: const TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                    ...
                    TextSpan(
                      text: translation(context).toMoveTheBlocksLeftAndRight,
                      style: const TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ),
              ...
              Image(
                image: const AssetImage("assets/images/tutorial/Slide3.PNG"),
