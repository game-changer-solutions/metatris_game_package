  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton:
          const TutorialPagesNextButton(routeName: RouteManager.tutorialPage8),
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                translation(context).scoringATetris,
              ...
              Image(
                image: const AssetImage("assets/images/tutorial/Slide7.PNG"),
                height: (MediaQuery.of(context).size.height / 2) - 20,
              ),
              const SizedBox(height: 20),
              Text(
                translation(context).useTheLongBar,
                style: const TextStyle(
                  fontSize: 20,
                ),
                textAlign: TextAlign.center,
